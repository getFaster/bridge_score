...
def calculate_bridge_score(result: str) -> int:
    ...
    assert 1 <= tricks_made <= 7 or -13 <= tricks_made <= -1, "Invalid tricks made/undertricks: {}".format(tricks_str)
    ...
    if tricks_made >= 0:
        ...
        total_score = base_score + game_bonus + slam_bonus + overtrick_value * (tricks_made - level) + insult_bonus
        return total_score
